package com.hospitalIS.controller.datastructure;
...
public class CustomQueue {
    ...
    private LinkedList<HospitalISModel> vivaList; // Internal storage for the queue.
     ...
     */
    public HospitalISModel deQueue() {
        try {
